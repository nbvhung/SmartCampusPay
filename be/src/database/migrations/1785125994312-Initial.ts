...
export class Initial1785125994312 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."cards_status_enum" AS ENUM('active', 'inactive', 'lost', 'frozen')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."merchants_type_enum" AS ENUM('canteen', 'library', 'parking', 'printing', 'other')`);
        ...
        await queryRunner.query(`ALTER TABLE "cards" ADD CONSTRAINT "FK_49d83b8c9d1e3163231dfb6c913" FOREIGN KEY ("studentId") REFERENCES "students"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "transactions" ADD CONSTRAINT "FK_88088ff46b6a3f09e1be51d35c4" FOREIGN KEY ("merchantId") REFERENCES "merchants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "accounts" ADD CONSTRAINT "FK_59b495f928610e8667c6d9e12ce" FOREIGN KEY ("studentId") REFERENCES "students"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "accounts" DROP CONSTRAINT "FK_59b495f928610e8667c6d9e12ce"`);
        ...
        await queryRunner.query(`ALTER TABLE "cards" DROP CONSTRAINT "FK_49d83b8c9d1e3163231dfb6c913"`);
